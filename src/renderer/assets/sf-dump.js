  ...
  (function (doc) {
    ...
    return function (root, x) {
      ...
      var indentRx = new RegExp(
        ...
        options = { maxDepth: 1, maxStringLength: 160, fileLinkFormat: null },
      ...
      a('mouseover', function (a, e, c) {
        if (c) {
          ...
          try {
            refStyle.innerHTML =
              'pre.sf-dump .' + a[0] + '{background-color: #B729D9; color: #FFF !important; border-radius: 2px}'
          } catch (e) {}
        }
      })
      ...
      if (doc.evaluate && Array.from && root.children.length > 1) {
        ...
        search.innerHTML = `
                <input type="text" class="sf-dump-search-input block px-2 py-1.5 w-full tracking-wider font-normal w-40 focus:outline-none focus:ring-1 focus:text-base1-700 dark:bg-base1-700 dark:text-base1-100 dark:placeholder-base1-400 rounded-md border border-gray-200 dark:!border-base1-500 focus:border-base1-300 focus:ring-base1-400 text-xs">
        ...
        addEventListener(searchInput, 'keyup', function (e) {
          ...
          searchInputTimer = setTimeout(function () {
            ...
            var classMatches = ['sf-dump-str', 'sf-dump-key', 'sf-dump-public', 'sf-dump-protected', 'sf-dump-private']
              .map(xpathHasClass)
              .join(' or ')
            var node
